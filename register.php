...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    try
    {
        ...
        $role = 'user';
        $sql = "INSERT INTO User (id, full_name, email, password, role) 
    ...
    {
        if ($e->getCode() == 23000) {
            $message = "Hata: Bu email adresi zaten kayıtlı.";
        } else {
...
<body>
    ...
    <div class="register-container">
        ...
        <?php if (!empty($message)): ?>
            <?php if (strpos($message, 'başarılı') !== false): ?>
